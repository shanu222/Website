...
function ProductsSection({ onNavigate }) {
  return (
    <section id="products" className="scroll-mt-24 py-6">
      <p className="text-xs uppercase tracking-[0.2em] text-cyan-200">Our Products</p>
      <h2 className="mt-2 text-2xl font-semibold text-white md:text-3xl">Our Products</h2>
      <motion.div
