...
function AboutSection() {
  return (
    <section id="about" className="scroll-mt-24 py-6">
      <p className="text-xs uppercase tracking-[0.2em] text-cyan-200">Who We Are</p>
      <h2 className="mt-2 text-2xl font-semibold text-white md:text-3xl">Mission-driven product team for sustainability outcomes.</h2>
      <motion.div {...fadeInUp} className="mt-6 grid gap-8 rounded-3xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-white/[0.02] p-6 shadow-[0_16px_40px_rgba(2,6,23,0.35)] md:grid-cols-2 md:p-10">
        ...
        <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-blue-500/20 to-cyan-400/10 p-6">
          <p className="text-sm uppercase tracking-[0.18em] text-cyan-200">What we do</p>
